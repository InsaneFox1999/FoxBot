...
const JOINTOCREATECHANNEL = '775990776307384360';
    ...
    client.on("voiceStateUpdate", (oldState, newState) => {
        ...
        if (oldState.channelID && !newState.channelID) {
                ...
                if (jointocreatemap.get(`tempvoicechannel_${oldState.guild.id}_${oldState.channelID}`)) {
                  ...
                  if (vc.members.size < 1) { 
                    ...
                    //console.log("[FoxBot]" + oldState.member.user.username + "#" + oldState.member.user.discriminator + " - Room wurde gelöscht")
        ...
        if (oldState.channelID && newState.channelID) {
          ...
          async function jointocreatechannel(user) {
            //log it 
            //console.log("[FoxBot]" + oldState.member.user.username + "#" + oldState.member.user.discriminator + " - Room wurde erstellt")
            ...
            await user.guild.channels.create(`${user.member.user.username}'s Room`, {
              type: 'voice',
              parent: "775990705117724693", //or set it as a category id
            }).then(async vc => {
